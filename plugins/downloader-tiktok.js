...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: 'ɢᴏᴋᴜ ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/_777charly' }, mentionedJid: [m.sender]}}}, aa)    
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: 'ɢᴏᴋᴜ ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/_777charly' }, mentionedJid: [m.sender]}}}, aa2)    
conn.relayMessage(m.chat, prep.message, { messageId: prep.key.id, mentions: [m.sender] })
